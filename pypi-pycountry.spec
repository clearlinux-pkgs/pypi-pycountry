...
Source0  : https://files.pythonhosted.org/packages/08/4a/137f422423b9c85148183691da65c5c843a209b7fc0c33a5144489366f53/pycountry-23.12.11.tar.gz
...
%prep
%setup -q -n pycountry-23.12.11
cd %{_builddir}/pycountry-23.12.11
pushd ..
cp -a pycountry-23.12.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702930038
